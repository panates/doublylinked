...
/**
 * Adds one or more elements to after cursor node of the list and returns
...
DoublyLinked.prototype.prev = function() {
  var c = this._priv.cursor && this._priv.cursor.prev;
  this._priv.cursor = c;
  return c && c.value;
};
 ...
 *
 * @return {DoublyLinked} - The DoublyLinked instance which this method is called
 * @public
 */
...
DoublyLinked.prototype[Symbol.iterator] = function() {
  ...
  return {
    next: function() {
      _cursor = _first ? _head : (_cursor && _cursor.next);
      _first = false;
      return _cursor && _cursor.value;
    }
  };
};
